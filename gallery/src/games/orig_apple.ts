...
// Normal camera — 4-direction movement, objects fall from above at z=0.
const apple: GameDSLConfig = {
  id: 'dc_apple',
  name: 'Apple Catch',
  mechanism: 'dodge_and_catch',
  assets: {
    models: { player: '', box1: '', box2: '', box3: '' },
    sounds: {
  ...
  world: {
    ...
    hasGround: true,
    ground: { width: 400, height: 10, depth: 400, posY: -20 },
    cameraType: 'normal',
    cameraFovScale: 1,
  ...
  objects: [
    {
      ...
      initialSpeed: { x: 0, y: -30, z: 0 } as any,
      motionType: 2,
    },
    {
      name: 'gift box',
