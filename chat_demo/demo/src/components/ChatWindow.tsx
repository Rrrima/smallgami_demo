/**
 * @file ChatWindow.tsx
 * @description Full-panel chat component with visible message history.
 * Used as the left panel in chat_demo layout.
 * Messages are shown (not commented out like in block_fillin_demo).
 */
